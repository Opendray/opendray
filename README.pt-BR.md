...
<p align="center">
  <strong>Gateway self-hosted para Claude Code · Codex · Antigravity · shell, com uma camada de memória local-first compartilhada entre todos eles.</strong>
  <br/>
...
**v2.7.6** (último). A geração v2 segue iterando. Veja
