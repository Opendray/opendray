...
const INLINE: Record<string, IconData> = {
	...
	// Hex 10A37F is OpenAI's contemporary brand mark colour (the
	// teal/green used in ChatGPT / API console); 412991 was the
	// older purple wordmark and reads as dark-on-dark on the admin
	// theme.
	openai: {
		title: 'OpenAI',
		hex: '10A37F',
	...
	// doesn't share Claude's colour by default. Bumped from the
	// near-black 4D4D4D (invisible on the dark admin theme) to a
	// mid-light grey that still reads as "neutral / utility" while
	// staying legible against bg-popover.
	shell: {
		title: 'Shell',
		hex: '9CA3AF',
		path:
