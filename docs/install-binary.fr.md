...
|---|---|---|---|
| `OPENDRAY_DATABASE_URL` | **oui** | aucun | DSN Postgres |
| `OPENDRAY_ADMIN_PASSWORD` | recommandé | aucun | Mot de passe admin web/mobile |
...
- [`docs/operator-guide.md`](operator-guide.md) : ops autour de la topologie reverse-proxy/TLS,
