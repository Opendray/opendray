...
func RenderRawMarkdown(s Summary) string {
	...
	b.WriteString("_Auto-generated by opendray git activity scanner. Do not hand-edit._\n\n")
	fmt.Fprintf(&b, "_Window: since %s · %d commits · %d files · +%d / -%d lines · generated %s_\n\n",
...
func composeFinalMarkdown(s Summary, llmBody string) string {
	var b strings.Builder
	b.WriteString("_Auto-generated by opendray git activity scanner + LLM summariser._\n\n")
	fmt.Fprintf(&b, "_Window: since %s · %d commits · %d files · +%d / -%d lines · generated %s_\n\n",
		s.WindowSince, s.TotalCommits, s.TotalFiles, s.TotalInserts, s.TotalDeletes,
		s.GeneratedAt.Format(time.RFC3339))
